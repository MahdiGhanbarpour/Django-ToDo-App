...
class TestPostApi:
    ...
    def test_put_task_detail_logged_in_response_200_status(self, common_user, common_task):
        self.client.force_login(common_user)
    ...
    def test_delete_task_detail_logged_in_response_204_status(self, common_user, common_task):
        self.client.force_login(common_user)
    ...
    def test_post_task_detail_change_status_anonymous_response_401_status(self, common_task):
    ...
    def test_post_task_detail_change_status_logged_in_response_200_status(self, common_user, common_task):
        self.client.force_login(common_user)
        common_task_id = common_task.id
        ...
        assert response.status_code == 200
        assert Task.objects.get(pk=common_task_id).is_done == True