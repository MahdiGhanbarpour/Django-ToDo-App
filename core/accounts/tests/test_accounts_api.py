...
class TestPostApi:
    ...
    def test_get_activation_confirm_invalid_token_response_400_status(self):
        invalid_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXh \
                wIjoxNzI2NTgxNzQ0LCJpYXQiOjE3MjY1ODE0NDQsImp0aSI6IjJjYWVkNjI1ODE5MzQ2ZWNiZmViZmE3Z \
                DA2YWY1YmE5IiwidXNlcl9pZCI6Nn0.es6UcS20Nv_2m06N-DArAg6e5pXQoGq_sNlL-cg_EIw"
    ...
    def test_put_change_password_logged_in_invalid_data_response_400_status(
        self, common_user
    ):
    ...
    def test_post_reset_password_confirm_invalid_token_response_400_status(self):
        url = reverse(
            "accounts:api-v1:reset-password-confirm", kwargs={"token": "Invalid Token"}
        )
